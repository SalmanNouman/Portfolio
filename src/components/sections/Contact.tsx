  ...
  return (
    <section id="contact" className="py-24 px-6 md:px-10 max-w-7xl mx-auto">
      <motion.div
        ...
        className="flex flex-col items-center text-center bg-accent/5 p-12 md:p-24 rounded-3xl"
      >
        <h2 className="text-sm font-medium uppercase tracking-[0.2em] mb-4 text-muted-foreground">
          Get in touch
        </h2>
        <h3 className="font-display text-4xl md:text-6xl lg:text-7xl leading-tight mb-8">
